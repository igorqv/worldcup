...
Passos
- Instalado o Antigravity
- Instalado o Claude Code no Antigravity (Feito o login na versão Pro)
- Alterado o /Model para o Haiku
- Feito o download dos arquivos do Kaggle
- Acesso a pasta do projeto 'worldcup'
- Inserido a pasta 'archive' na pasta do projeto
